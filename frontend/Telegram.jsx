...
// Mock Telegram conversation data
const mockConversations = [
  {
    id: 1,
    contact_name: 'Alex Thompson',
    username: '@alexthompson',
    last_message: 'Thanks for the information about your services!',
  ...
  },
  {
    ...
    last_message: 'Is it possible to book an appointment for next week?',
...
const mockMessages = [
  {
    id: 1,
    conversation_id: 1,
    message_text: 'Hello! I found your clinic on Telegram and wanted to learn more about your services.',
  ...
  },
  {
    id: 2,
    conversation_id: 1,
    message_text: 'Hi Alex! Welcome to our Telegram channel. I\'d be happy to tell you about our services. What specific treatments are you interested in?',
    sender_type: 'ai',
  ...
  },
  {
    id: 3,
    conversation_id: 1,
    message_text: 'I\'m interested in teeth whitening and possibly Invisalign.',
    sender_type: 'customer',
    sender_name: 'Alex Thompson',
  ...
  },
  {
    id: 4,
    conversation_id: 1,
    message_text: "Great choices! For teeth whitening, we offer both in-office and take-home options. Our in-office treatment takes about an hour and provides immediate results. For Invisalign, we'd need to schedule a consultation first to determine if you're a good candidate.",
    sender_type: 'ai',
    sender_name: 'Craft AI Assistant',
  ...
  },
  {
    id: 5,
    conversation_id: 1,
    message_text: 'That sounds good. How much does the in-office whitening cost?',
    sender_type: 'customer',
    sender_name: 'Alex Thompson',
  ...
  },
  {
    id: 6,
    conversation_id: 1,
    message_text: 'Let me transfer you to our treatment coordinator who can provide you with detailed pricing information.',
    sender_type: 'ai',
    sender_name: 'Craft AI Assistant',
  ...
  },
  {
    id: 7,
    conversation_id: 1,
    message_text: 'Hi Alex, I\'m Sarah from the clinic. Our in-office whitening is $350 for a single session, which includes a take-home maintenance kit. We also have a special this month that includes a free cleaning with any whitening treatment.',
    sender_type: 'human',
  ...
  },
  {
    id: 8,
    conversation_id: 1,
    message_text: 'Thanks for the information about your services!',
    sender_type: 'customer',
    sender_name: 'Alex Thompson',
...
const mockMessagesConv2 = [
  {
    id: 9,
    conversation_id: 2,
    message_text: 'Hello, I\'m interested in scheduling an appointment',
    sender_type: 'customer',
  ...
  },
  {
    id: 10,
    conversation_id: 2,
    message_text: 'Hi Maria! I\'d be happy to help you schedule an appointment. What type of service are you looking for?',
    sender_type: 'ai',
    sender_name: 'Craft AI Assistant',
  ...
  },
  {
    id: 11,
    conversation_id: 2,
    message_text: 'I need a regular dental checkup and cleaning',
    sender_type: 'customer',
    sender_name: 'Maria Garcia',
  ...
  },
  {
    id: 12,
    conversation_id: 2,
    message_text: 'Is it possible to book an appointment for next week?',
    sender_type: 'customer',
    sender_name: 'Maria Garcia',
...
const quickReplyTemplates = [
  "Thank you for reaching out on Telegram. How can I assist you today?",
  "I'll check our availability and get back to you shortly.",
  "Your appointment has been confirmed for [date/time].",
  "We're open Monday-Friday 9am-6pm and Saturday 9am-2pm.",
...
export default function Telegram() {
  ...
  const handleEndHandoff = (conversationId) => {
    ...
    console.log(`Telegram Handoff completed for conversation ${conversationId} by ${user?.first_name || user?.username || 'Agent'}`);
  };
    ...
    <div className="p-4 space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600">Monitor all Telegram conversations and AI interactions</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <Card className="lg:col-span-1 shadow-sm">
          <CardHeader className="p-4 pb-2">
            ...
            <CardDescription className="text-xs">All Telegram conversations</CardDescription>
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-gray-500">{conversation.username}</p>
                      </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-xs">
                  {selectedConversation 
                    ? `${selectedConversation.username} • ${messages.length} messages`
