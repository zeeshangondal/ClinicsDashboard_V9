...
// Mock WhatsApp conversation data
const mockConversations = [
  {
    id: 1,
    contact_name: 'Jane Smith',
    phone_number: '+1234567890',
    last_message: 'Thank you for confirming my appointment!',
  ...
  },
  {
    ...
    last_message: 'Do you have any availability next Tuesday?',
  ...
  },
  {
    ...
    last_message: 'I need to reschedule my appointment.',
...
const mockMessages = [
  {
    id: 1,
    conversation_id: 1,
    message_text: 'Hello! I would like to schedule an appointment for a dental checkup.',
  ...
  },
  {
    id: 2,
    conversation_id: 1,
    message_text: 'Hi Jane! I\'d be happy to help you schedule an appointment. When would you prefer to come in?',
    sender_type: 'ai',
  ...
  },
  {
    id: 3,
    conversation_id: 1,
    message_text: 'I was hoping to come in sometime next week, preferably in the morning.',
    sender_type: 'customer',
    sender_name: 'Jane Smith',
  ...
  },
  {
    id: 4,
    conversation_id: 1,
    message_text: "We have availability on Tuesday at 9:00 AM or Thursday at 10:30 AM next week. Would either of those times work for you?",
    sender_type: 'ai',
    sender_name: 'Craft AI Assistant',
  ...
  },
  {
    id: 5,
    conversation_id: 1,
    message_text: 'Tuesday at 9:00 AM would be perfect.',
    sender_type: 'customer',
    sender_name: 'Jane Smith',
  ...
  },
  {
    id: 6,
    conversation_id: 1,
    message_text: 'Let me transfer you to our scheduling coordinator who can confirm your appointment.',
    sender_type: 'ai',
    sender_name: 'Craft AI Assistant',
  ...
  },
  {
    id: 7,
    conversation_id: 1,
    message_text: 'Hi Jane, I\'m Sarah from the clinic. I\'ve confirmed your appointment for Tuesday, January 23rd at 9:00 AM with Dr. Martinez. Please arrive 15 minutes early to complete any necessary paperwork.',
    sender_type: 'human',
  ...
  },
  {
    id: 8,
    conversation_id: 1,
    message_text: 'Thank you for confirming my appointment!',
    sender_type: 'customer',
    sender_name: 'Jane Smith',
...
const mockMessagesConv2 = [
  {
    id: 9,
    conversation_id: 2,
    message_text: 'Hello, I\'m interested in scheduling a teeth whitening session',
    sender_type: 'customer',
  ...
  },
  {
    id: 10,
    conversation_id: 2,
    message_text: 'Hi John! I\'d be happy to help you schedule a teeth whitening session. We offer both in-office and take-home whitening options. Which one are you interested in?',
    sender_type: 'ai',
    sender_name: 'Craft AI Assistant',
  ...
  },
  {
    id: 11,
    conversation_id: 2,
    message_text: 'I\'d prefer the in-office option. How long does it take?',
    sender_type: 'customer',
    sender_name: 'John Doe',
  ...
  },
  {
    id: 12,
    conversation_id: 2,
    message_text: 'Our in-office whitening treatment takes about 60-90 minutes. The results are immediate, and you can expect your teeth to be several shades whiter after just one session.',
    sender_type: 'ai',
    sender_name: 'Craft AI Assistant',
  ...
  },
  {
    id: 13,
    conversation_id: 2,
    message_text: 'That sounds great. Do you have any availability next Tuesday?',
    sender_type: 'customer',
    sender_name: 'John Doe',
...
const mockMessagesConv3 = [
  {
    id: 14,
    conversation_id: 3,
    message_text: 'I need to reschedule my appointment.',
    sender_type: 'customer',
...
export default function WhatsApp() {
  ...
  const handleEndHandoff = (conversationId) => {
    ...
    console.log(`Handoff completed for conversation ${conversationId} by ${user?.first_name || user?.username || 'Agent'}`);
  };
    ...
    <div className="p-4 space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600">Monitor all WhatsApp conversations and AI interactions</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <Card className="lg:col-span-1 shadow-sm">
          <CardHeader className="p-4 pb-2">
            ...
            <CardDescription className="text-xs">All WhatsApp conversations</CardDescription>
